...
struct MainMessagesView: View {
            ...
            if !viewModel.UserCurrentlyLoggedOut {
                ...
                VStack {
                    ...
                    NavigationLink("", isActive: $navigateToChatLogView) {
                        MessageLogView(appUser: viewModel.appUser)
                    }
                }.overlay(
    ...
    private var CustomNavigationBar: some View {
        ...
        .actionSheet(isPresented: $shouldShowLogOutOptions) {
            .init(title: Text(""), message: Text("Sure You Want to Log Out?"),
                  buttons:
                    [ .destructive(Text("Log Me Out"), action: {
